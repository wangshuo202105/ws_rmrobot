...
struct Ort_Teach_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _teach_type_type;
...
struct Printer< ::rm_msgs::Ort_Teach_<ContainerAllocator> >
{
  ...
  {
    s << indent << "teach_type: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.teach_type);
    s << indent << "direction: ";
