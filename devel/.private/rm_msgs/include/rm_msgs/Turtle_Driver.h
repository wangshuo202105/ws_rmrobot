...
struct Turtle_Driver_
{
  ...
  _message_type_type message_type;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _robot_mac_address_type;
...
struct Printer< ::rm_msgs::Turtle_Driver_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rm_msgs::Turtle_Driver_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.robot_mac_address);
    s << indent << "vx: ";
